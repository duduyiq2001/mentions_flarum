...
use s9e\TextFormatter\Plugins\Autoemail\Configurator as AutoemailConfigurator;
...
class ConfigureMentions
{
    ...
    public const WORKFLOW_REGEX = '/\b(?:@?Workflow|workflow)(?<id1>\d+)\b/';
    public const PROJECT_REGEX = '/\b(?:@?Project|project)(?<id1>\d+)\b/';
    ...
    private function configureWorkflowMentions(Configurator $Config): void{
        error_log("ednkeenkfnef");
    ...
    $Config->Preg->match(self::WORKFLOW_REGEX, $tagName);
    



    }
    private function configureProjectMentions(Configurator $Config): void{
        error_log("ednkeenkfnef");
